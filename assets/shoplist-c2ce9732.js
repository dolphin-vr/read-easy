import{s as o,a as p}from"./sprite-596ea2eb.js";o("test@g.com","12345678").then(s=>{console.log("signInApp success"),console.log(s)}).catch(s=>{console.log("signInApp wrong")});const n=[{_id,title,author,list_name,description,book_image,buy_links:[url1,url2,url3]}];n.map(s=>t(s)).join("");function t(s){return`<li class="shopping-card">
