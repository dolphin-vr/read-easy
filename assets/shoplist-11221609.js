import{s as o}from"./api-firebase-f6237cef.js";const p="/read-easy/assets/sprite-c6a76667.svg";o("test@g.com","12345678").then(s=>{console.log("signInApp success"),console.log(s)}).catch(s=>{console.log("signInApp wrong")});const t=[{_id,title,author,list_name,description,book_image,buy_links:[url1,url2,url3]}];t.map(s=>n(s)).join("");function n(s){return`<li class="shopping-card">
